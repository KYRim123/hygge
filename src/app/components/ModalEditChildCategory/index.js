...
export default function ModalEditCategoryChild({setShowModal , handleEditCategoryChild, categories , idCategory,titleCategory,nameItem}) {
    const selectRef = useRef(null);
    const [name_new_category_child,set_name_new_category_child] = useState(nameItem);
        ...
        >
            <div className="relative w-auto my-6 mx-auto max-w-3xl" style={{ width: '600px' }}>
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                ></SelectDropdown>
                <div className={style.title_input}>Name Category</div> 
                ...
                <div className="flex items-center justify-end p-6 border-t border-solid border-blueGray-200 rounded-b">
                  ...
                  <button
                    ...
                    type="button"
                    disabled={name_new_category_child === '' ? true : false}
                    style={{ backgroundColor:name_new_category_child === '' ? "#ccc" : '' }}
                    onClick={() => {setShowModal(false);handleEditCategoryChild(name_new_category_child,id_category,name_category)}}
                  >
                    EDIT
                  </button>
                </div>
